...
global.devs = "971562804817";
global.sudo = process.env.SUDO || "971558510406,923009125228";
global.owner = process.env.OWNER_NUMBER || "971562804817";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "𝐅𝐈𝐋𝐄-𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐄𝐃-𝐁𝐘-Bilal-𝐌𝐃-𝐕2😍",
  author: process.env.PACK_AUTHER || "𝄟✮͢🦋⃟≛⃝ вιℓαℓ αωαиzα∂α𝄟-+971558510406",
  packname: process.env.PACK_NAME || "𝄟✮͢🦋⃟≛⃝ вιℓαℓ αωαиzα∂α𝄟",
  botname: process.env.BOT_NAME || "◄⏤‌𝐈𝛕ᷟ‌𝚣⃪ꙴ➺𝄟⃝🦋 𝑩𝒊𝒍𝒂𝒍 𝑨𝒘𝒂𝒏𝒛𝒂𝒅𝒂🦋⃝𝄟",
  ownername: process.env.OWNER_NAME || "𝄟✮͢🦋⃟≛⃝ вιℓαℓ αωαиzα∂α𝄟",
